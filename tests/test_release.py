...
def readme(_bullets: list[str], extra: str = "") -> str:
...
def test_release_run_leaves_the_readme_alone(repo):
...
def test_guard_lets_a_branch_edit_the_readme(repo, capsys):
    """Release history lives in CHANGELOG.md, so README edits are ordinary docs work."""
    branch(repo)
