...
async def test_reader_dev_bypass(client):
    ...
    settings.browser_dev_user = "rich"
    try:
...
async def test_post_with_refs_round_trip(client):
    refs = [
        {"kind": "pr", "value": "45", "repo": "rich/quarterback"},
        {"kind": "commit", "value": "abc123def", "repo": "rich/quarterback"},
    ]
    pid = (
        await client.post(
            "/post",
...
def snapshot():
    return {
        ...
        "worktrees": [
            {
                "path": "/home/rich/source/quarterback",
                "repo": "rich/quarterback",
                "branch": "master",
                "head": "1111111aaaaaaaa",
                "commits": [{"sha": "1111111aaaaaaaa", "subject": "root"}],
            },
            {
                "path": "/home/rich/source/quarterback-feat",
                "repo": "rich/quarterback",
                "branch": "feat-x",
...
async def test_worktrees_register_and_query(client, snapshot):
    ...
    rows = (
        await client.get("/worktrees", params={"repo": "rich/quarterback"}, headers=LAPTOP)
    ).json()
