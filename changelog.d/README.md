...
That is **output**. `scripts/release.py run` writes it and nothing else does, and a branch
that edits its release entries is refused — by `harness/githooks/pre-push` at the moment you
