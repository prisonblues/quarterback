...
Each of those now asks its question of the newest run that actually reviewed, chosen *after*
the selection rather than filtered before it. Two of the three were caught by a second-opinion
review rather than by the author, which is the argument for asking.
