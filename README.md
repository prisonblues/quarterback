...
tooling asks who is in a directory before rewriting it. v2.18 before it settled a reply carrying
several JSON-shaped values by agreement rather than by rank, and v2.17 made a reviewer that produced
nothing a failure that says why. The last release that moved the board was **v2.15**, which added
the round and coverage columns; v2.13 (shipping the harness) and v2.14 (merging findings in the
